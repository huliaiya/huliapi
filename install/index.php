  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <form method="post" id="install-form">
        ...
        <div class="form-group mb-4"><label class="form-check-label"><input class="form-check-input" type="checkbox" name="turnstile_enabled" value="1" <?= (!empty($_SESSION['install_config']['turnstile_enabled']) || empty($_SESSION['install_config'])) ? 'checked' : '' ?>> 启用 Cloudflare Turnstile 人机验证（选中后须填写下方两个 Key）</label></div>
        <div class="form-row">
