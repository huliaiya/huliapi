...
DROP TABLE IF EXISTS `sl_advertisements`;
CREATE TABLE `sl_advertisements` (
...
INSERT INTO `sl_billing_plans` (`id`,`name`,`description`,`price`,`billing_type`,`balance_to_add`,`points_to_add`,`membership_days`,`is_active`,`is_card`,`created_at`) VALUES
...
DROP TABLE IF EXISTS `sl_qps_logs`;
CREATE TABLE `sl_qps_logs` (
...
DROP TABLE IF EXISTS `sl_daily_points_claim`;
CREATE TABLE `sl_daily_points_claim` (
...
DROP TABLE IF EXISTS `sl_daily_stats`;
