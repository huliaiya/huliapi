            ...
            <div class="tab-content">
              <div class="tab-pane fade show active" id="config" aria-labelledby="basic-config">
                ...
                <div class="mb-3">
                  ...
                  <input class="form-control" type="text" id="police_record_number" name="police_record_number" value="<?php echo htmlspecialchars($settings['police_record_number'] ?? ''); ?>" placeholder="例如：鄂公网安备42022202000162号">
                </div>
                <div>
